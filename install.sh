...
if [ "$1" != "" ]; then
    ...
    cp -R agbcc_src/libc/include/ $1/tools/agbcc/ #drop include, because we don't want include/include
    ...
    cp librfu_1024.a $1/tools/agbcc/lib/
    cp librfu_1026.a $1/tools/agbcc/lib/
